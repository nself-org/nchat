...
function formatSummaryData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
  ...
  const data: Record<string, unknown>[] = [
    ...
    },
    {
      ...
      changePercent: summary.users.totalUsers.changePercent,
    },
    {
      category: "Users",
      metric: "Active",
    ...
    },
    {
      ...
      trend: summary.channels.totalChannels.trend,
      changePercent: summary.channels.totalChannels.changePercent,
    },
    {
      category: "Channels",
      metric: "Active",
...
function formatMessagesData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
...
function formatUsersData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
  const headers = [
...
function formatChannelsData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
  const headers = [
...
function formatReactionsData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
...
function formatPeakHoursData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
...
function formatFilesData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
...
function formatSearchData(dashboard: DashboardData): {
  data: Record<string, unknown>[];
  headers: string[];
} {
  ...
  try {
    ...
    if (format === "json") {
      ...
      sections.forEach((section) => {
        switch (section) {
          case "summary":
            (exportData.sections as Record<string, unknown>).summary =
              dashboardData.summary;
            break;
          case "messages":
            (exportData.sections as Record<string, unknown>).messages =
              dashboardData.messageVolume;
            break;
          case "users":
            (exportData.sections as Record<string, unknown>).users =
              dashboardData.topUsers;
            break;
          case "channels":
            (exportData.sections as Record<string, unknown>).channels =
              dashboardData.channelActivity;
            break;
          case "reactions":
            (exportData.sections as Record<string, unknown>).reactions =
              dashboardData.reactions;
            break;
          case "peakHours":
            (exportData.sections as Record<string, unknown>).peakHours =
              dashboardData.peakHours;
            break;
          case "files":
            (exportData.sections as Record<string, unknown>).files =
              dashboardData.fileUploads;
            break;
          case "search":
            (exportData.sections as Record<string, unknown>).search =
              dashboardData.searchQueries;
            break;
        }
      });

...
export class PreKeyBundle {
  static new(
    ...
    const valid = identityKey.verify(
...
export class IdentityKeyStore {
  ...
  constructor(
    identityKey: { publicKey: Buffer; privateKey: Buffer },
    registrationId: number,
  ) {
...
export class KyberPreKeyRecord {
  ...
  publicKey(): KEMPublicKey {
    return KEMPublicKey.deserialize(this._data.slice(4, 36));
  }

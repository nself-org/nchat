 ...
 */
export const LazyCallWindow = dynamic(
  () => import("@/components/calls/call-window"),
  {
...
export const LazyScreenShare = dynamic(
 ...
 */
export const LazyEmojiPicker = dynamic(() => import("emoji-picker-react"), {
  loading: () => <DefaultLoadingState />,
  ssr: false,
});
...
export async function loadToxicityDetector() {
  const { ToxicityDetector } =
    await import("@/lib/moderation/toxicity-detector");

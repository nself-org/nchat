...
export const FEATURE_REGISTRY: readonly Feature[] = [
  ...
  // ===========================================================================
  {
    ...
    category: "messaging",
    description:
      "Send text messages to channels and DMs with full formatting support",
    status: "in_progress",
    dependencies: [],
  ...
  // ===========================================================================
  {
    ...
    category: "media",
    description:
      "Upload images with automatic compression and thumbnail generation",
    status: "in_progress",
    dependencies: [],
    backend_enforced: true,
    plan_restrictions: [],
  ...
  },
  {
    ...
    db_tables: [
      "nchat_analytics_messages",
      "nchat_analytics_users",
      "nchat_analytics_channels",
    ],
...
export function getFeaturesByPlan(plan: PlanLevel): Feature[] {
  return FEATURE_REGISTRY.filter(
    (f) =>
      f.plan_restrictions.length === 0 || f.plan_restrictions.includes(plan),
  ) as Feature[];
}
...
export function getFeatureStats(): {
  ...
  stats.completion_percentage = Math.round(
    (stats.by_status.complete / stats.total) * 100,
  );
...
> = {
  messaging: {
    name: "Messaging",
    description:
      "Core messaging features including text, reactions, threads, and scheduling",
    icon: "MessageSquare",
  },
  channels: {

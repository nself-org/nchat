    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-20">
          <TemplateIcon templateId={templateId} className="h-24 w-24" />
        </div>
      ...
      <CardContent className="pb-2">
        {/* Color Preview */}
        <div className="mb-3">
          <p className="mb-1 text-xs text-muted-foreground">Color Scheme</p>
          <ColorPreview colors={previewColors} size="md" />
        </div>

        {/* Feature Highlights */}
        <div>
          <p className="mb-1 text-xs text-muted-foreground">Highlights</p>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: preset.dark.primaryColor }}
      >
        <TemplateIcon templateId={templateId} className="h-5 w-5 text-white" />
      </div>

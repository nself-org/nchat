    ...
    <div className="mx-auto max-w-4xl">
      <div className="mb-8 text-center">
        ...
        <p className="mx-auto max-w-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
          Customize every aspect of your app's appearance with full control over
          colors, buttons, and UI elements.
        </p>
      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex -space-x-1">
                          <div
                            ...
                            style={{
                              backgroundColor: preset.light.primaryColor,
                            }}
                          />
                          <div
                            className="h-3 w-3 rounded-full border border-white dark:border-zinc-800"
                            style={{
                              backgroundColor: preset.light.secondaryColor,
                            }}
                          />
                          <div
                            className="h-3 w-3 rounded-full border border-white dark:border-zinc-800"
                            style={{
                              backgroundColor: preset.light.accentColor,
                            }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex -space-x-1">
                          ...
                          <div
                            className="h-3 w-3 rounded-full border border-white dark:border-zinc-800"
                            style={{
                              backgroundColor: preset.dark.secondaryColor,
                            }}
                          />
                          <div
                            className="h-3 w-3 rounded-full border border-white dark:border-zinc-800"
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex -space-x-1">
                            ...
                            <div
                              className="h-3 w-3 rounded-full border border-white dark:border-zinc-800"
                              style={{
                                backgroundColor: preset.dark.accentColor,
                              }}
                            />
                          </div>
                        </div>
        ...
        <TabsContent value="customize" className="mt-6 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Core colors that define your app's identity
              </CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-2 gap-4 md:grid-cols-3">
              ...
              <ColorInput
                ...
                onChange={(v: string) =>
                  handleColorChange("backgroundColor", v)
                }
                inputRef={bgColorRef}
              />
              <ColorInput
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <ColorInput
                ...
                onChange={(v: string) =>
                  handleColorChange("buttonPrimaryBg", v)
                }
              ...
              <ColorInput
                ...
                onChange={(v: string) =>
                  handleColorChange("buttonPrimaryText", v)
                }
              ...
              <ColorInput
                ...
                onChange={(v: string) =>
                  handleColorChange("buttonSecondaryBg", v)
                }
              ...
              <ColorInput
                ...
                onChange={(v: string) =>
                  handleColorChange("buttonSecondaryText", v)
                }
        ...
        <TabsContent value="import" className="mt-6 space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Paste a theme JSON to import custom settings
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Textarea
            ...
            <div className="flex h-64">
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="p-2">
                    <span
                      style={{ color: previewTheme.mutedColor }}
                      className="text-sm"
                    >
                      Menu Item
                    </span>

...
export function DeploymentStep({
  ...
  const deploySettings = (
    config as AppConfig & { deploymentSettings?: DeploymentSettings }
  ).deploymentSettings;
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Choose how you want to deploy your chat application. You can
              deploy the backend, frontend, desktop apps, and mobile apps
              independently.
            </p>
          </div>
        </div>
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Deploy your backend services (PostgreSQL, Hasura, Auth, Storage) to
            your server.
          </p>
          ...
          {targets.backend === "nself" && (
            <div className="mt-4 space-y-3">
              ...
              <CommandBlock
                ...
                onCopy={copyCommand}
                copied={
                  copiedCommand === "cd .backend && nself deploy production"
                }
              />
          ...
          {targets.frontend === "vercel" && (
            <div className="mt-4 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Or use the CLI:{" "}
                <code className="rounded bg-muted px-1">npx vercel --prod</code>
              </p>
            </div>
          )}
        ...
        <div className="space-y-4">
          ...
          {(targets.desktop === "electron" || targets.desktop === "both") && (
            <div className="mt-4 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Output:{" "}
                <code className="rounded bg-muted px-1">dist-electron/</code>
              </p>
            </div>
          )}
        </div>
          ...
          {(targets.mobile === "react-native" || targets.mobile === "both") && (
            <div className="mt-4 space-y-3">
              ...
              <CommandBlock
                ...
                copied={
                  copiedCommand ===
                  "cd platforms/react-native && npx react-native run-ios"
                }
              />
              ...
              <CommandBlock
                ...
                copied={
                  copiedCommand ===
                  "cd platforms/react-native && npx react-native run-android"
                }
              />
            </div>
          )}

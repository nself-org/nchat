 ...
 *
 * Displays a single slash command in the command menu.
 * Shows command icon, name, description, and optional keyboard shortcut.
 *
 * @example
 * ```tsx
 * <CommandItem
...
export function CommandItem({
  ...
  return (
    ...
    >
      ...
      {/* Keyboard Shortcut */}
      {command.shortcut && (
        <kbd className="hidden items-center rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-muted-foreground sm:inline-flex">
          {command.shortcut}
        </kbd>
      )}
      ...
      {onFavoriteToggle && (
        ...
        >
          {isFavorite ? (
            ...
            <CommandIcons.star className="h-4 w-4" />
          )}
        </button>
      )}
    </div>
